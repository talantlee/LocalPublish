...
namespace AutoLocalPublish
{
    public partial class MoveRootForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            List<string> extRootExternalDLLs = (List<string>)System.Configuration.ConfigurationManager.GetSection("ToRootList");
         ...
         //  string[] RootExternalDLLs = Form1.RootExternalDLLs;
            ...
            if (Form1.RootExternalDLLs.Length > 0)
                foreach (string f in rootFileList)
                {
                    if (Form1.RootExternalDLLs.Contains(Path.GetFileName(f)) || extRootExternalDLLs.Contains(Path.GetFileName(f)))
                    {
